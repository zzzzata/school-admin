...
//	        }
	...
	show : function(courseId , isCourse , isChapter , isSection , scallback){
        ...
        that.layerIndex = layer.open({
			...
			content : jQuery("#adlCourseTreeLayDiv"),
	...
	reload:function(){
		var that = this;
		//加载部门树
		$.get("../adaptive/layer/courseTree/"+ that.courseId, function(r){
			ztree = $.fn.zTree.init($("#adlCourseTreeLayTree"), that.setting, r.data);
			// 展开所有节点
