 ...
 * 专业js
 */
var professionAllLay = {
	scallback : null,//回调方法
	layerIndex : null,//浮层index
	layerTitle : "专业列表",//标题
	layerHeigh : '450px',//高度
	layerWeigh : '300px',//宽度
	url : "../layerdata/professionAllList",//地址
	moduleName : "profession",
	jqGridLay : "professionAllLay_jqGrid",
	_jqGridDiv : "#professionAllLayDiv",
	_jqGridLay : "#professionAllLay_jqGrid",
	init : function(){
		var that = this;
