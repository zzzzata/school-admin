$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '免考核课程', name: 'course', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.freeAssessment.id == null ? "../freeassessment/save" : "../freeassessment/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.freeAssessment),
			    success: function(r){
			    	if(r.code === 0){
		...
		getInfo: function(id){
			$.get("../freeassessment/info/"+id, function(r){
                vm.freeAssessment = r.freeAssessment;
            });
		},
        ...
        downTemplate: function () {
            var urlstr = "../freeassessment/downTemplate";
        ...
        batchImport: function () {
            layer.open({
                ...
                btn1: function (index) {
                    $.ajaxFileUpload({
                        url: '../freeassessment/batchImport',
                        secureuri: true,
