...
public class NumberUtils {
	...
	/**
	 * 将字符串转为整数  ,如果出错则返回reeors的值
	 *@param str
	 *@return
	 * @author lintf
	 * 2018年8月14日
	 */
	public static int stringToInt(String str,int errors) {
		try {
			if (str.equals("是")||str.equals("1")||str.contains("已")) {
				return 1;
			}else if (str.equals("否")||str.equals("0")||str.contains("无")) {
				return 0;
			}
