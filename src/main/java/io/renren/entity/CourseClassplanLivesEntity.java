...
public class CourseClassplanLivesEntity implements Serializable {
	...
	public String toString() {
		return "CourseClassplanLivesEntity [classplanLiveId=" + classplanLiveId + ", classplanId=" + classplanId
				...
				+ ", attendance=" + attendance + ", fileName=" + fileName + ", reviewName=" + reviewName
				+ ", prepareName=" + prepareName + ", coursewareName=" + coursewareName + ", banSpeaking=" + banSpeaking
				+ ", banAsking=" + banAsking + ", hideDiscussion=" + hideDiscussion + ", hideAsking=" + hideAsking
				+ ", type=" + type + ", recordId=" + recordId + ", goodId=" + goodId + "]";
	}
